...
if(!class_exists('StellarBlocks\Blocks\IconButton')){
	class IconButton extends BaseBlockRenderer
	{
		/**
		...
		protected array $uniqueWrapperClasses = ['stk-block-icon-button'];
...
new IconButton($attributes, $content, $block);
