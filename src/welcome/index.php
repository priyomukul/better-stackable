...
<!--					--><?php //echo $this->print_premium_button() ?>
                ...
                <section class="s-body-container s-body-container-grid">
                    <div class="s-body">
						...
						<article class="s-box" id="color-settings">
							<h2><?php _e( '🎨 Color Settings', STACKABLE_I18N ) ?></h2>
							<p class="s-settings-subtitle"><?php _e( 'You can add or remove default colors here' , STACKABLE_I18N ) ?></em></p>
							<div class="stl-color-settings"></div>
						</article>
